    ...
    <>
      <header className="w-full fixed top-0 left-0 z-10 flex justify-between font-semibold items-center px-4 py-2 md:px-10 md:py-2 bg-gradient-to-b from-gray-400 to-[#a7d5e2] dark:from-gray-400 dark:to-[#a7d5e2]">
        ...
        <nav className="hidden md:flex items-center gap-6 md:gap-6 ml-auto">
          <Link href="/" legacyBehavior>
            <a className="text-[#103d50] dark:text-[#103d50] text-base md:text-lg lg:text-xl hover:underline">Home</a>
          </Link>
          <Link href="/" legacyBehavior>
            <a className="text-[#103d50] dark:text-[#103d50] text-base md:text-lg lg:text-xl hover:underline">Mobile Apps</a>
          </Link>
          <Link href="/" legacyBehavior>
            <a className="text-[#103d50] dark:text-[#103d50] text-base md:text-lg lg:text-xl hover:underline">Resources</a>
          </Link>
        </nav>
        
        <div className="hidden md:block ml-6">
          <button className="bg-[#103d50] hover:bg-[#092633] text-white font-semibold py-2 px-4 rounded-lg transition-colors">
            Get Started
          </button>
        </div>

        <div className="md:hidden flex items-center gap-4">
          <button className="bg-[#103d50] hover:bg-[#092633] text-white font-semibold py-2 px-3 rounded-lg transition-colors">
            Get Started
          </button>
        ...
        <div className={`absolute top-full left-0 w-full bg-white dark:bg-gray-100 shadow-lg transition-transform duration-300 ${openMenu ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0 pointer-events-none"} md:hidden`}>
          <nav className="flex flex-col items-center gap-4 py-4">
            <Link href="/" legacyBehavior>
              <a className="text-[#103d50] dark:text-[#103d50] text-lg hover:underline" onClick={toggleMenu}>Home</a>
            </Link>
            <Link href="/" legacyBehavior>
              <a className="text-[#103d50] dark:text-[#103d50] text-lg hover:underline" onClick={toggleMenu}>Mobile Apps</a>
            </Link>
            <Link href="/" legacyBehavior>
              <a className="text-[#103d50] dark:text-[#103d50] text-lg hover:underline" onClick={toggleMenu}>Resources</a>
            </Link>
          </nav>
        </div>
      </header>
