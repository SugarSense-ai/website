...
function Footer() {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center p-4 md:py-2 w-full font-semibold text-center bg-gradient-to-b from-[#a7d5e2] to-gray-400 dark:from-[#a7d5e2] dark:to-gray-400">
      ...
      <div className="flex justify-center items-center gap-4 md:gap-6">
        <a href="https://x.com" target="_blank" rel="noreferrer">
          <FaTwitter className="text-lg md:text-xl cursor-pointer text-text-[#103d50] hover:text-blue-600 transition duration-300" />
        </a>
        <a href="https://dribbble.com" target="_blank" rel="noreferrer">
          <FaDribbble className="text-lg md:text-xl cursor-pointer text-text-[#103d50] hover:text-blue-600 transition duration-300" />
        </a>
